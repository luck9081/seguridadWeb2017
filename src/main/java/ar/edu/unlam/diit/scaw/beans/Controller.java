...
public class Controller implements Serializable {
	...
	public String editarTarea(TareaBean tareaBean){
		
		String idTarea = FacesContext.getCurrentInstance().getExternalContext().getRequestParameterMap().get("idTarea");

		Tarea tarea = new Tarea();
		tarea.setId_tarea(Integer.parseInt(idTarea));
		tarea.setDescripcion(tareaBean.getDescripcion());
